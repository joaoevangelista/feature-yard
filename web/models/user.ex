defmodule Featureyard.User do
  ...
  def validate_password(nil, params),  do: validate_password(%Featureyard.User{}, params)
  ...
  defp login_changeset(model, params) do
    %Featureyard.User{encrypted_password: model.encrypted_password}
